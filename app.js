        ...
        $.ajax(
            ...
            function (response) {
                ...
                $.each(res, function (i, country) {
                    console.log(country)
                    $countryName.push(country.translations.fra.official)
                    $countryCapital.push(country.capital)
                    $countryFlag.push(country.flags.png)
                    $countryNumber.push(country.i)
                    $countryPopulation.push(country.population)
                    $countryCurrencies.push(country.currencies != undefined ? Object.values(country.currencies) : '')
                    $countrySubregion.push(country.subregion)
                })
